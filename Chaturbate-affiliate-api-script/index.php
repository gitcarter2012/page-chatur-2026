...
function renderModels(models) {
  ...
  // Re-attach interactive controls after grid HTML is replaced.
  if (window.addFavoriteButtons) {
    window.addFavoriteButtons();
  }
}
...
function setupFavoritesSystem() {
  ...
  function addFavoriteButtons() {
    document.querySelectorAll('.model-card-cb').forEach(card => {
      ...
      const cardTitle = card.querySelector('.model-username-cb, .username-cb, .card-title');
